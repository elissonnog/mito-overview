...
| `09_mito_identity_qc.html` | `identity_qc` | identity/fingerprint summary tables, retained/excluded ALT counts | concordance plot when sidecars exist | compares exact retained canonical PASS/dot mtDNA SNVs; conditional or not applicable |
