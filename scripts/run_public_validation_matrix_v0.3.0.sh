...
run_long_case() {
  ...
  local -a case_environment=(
    ...
    "MITO_OVERVIEW_LONGREAD_SUBSET_FASTQ=${CACHE_ROOT}/GM12878/downloads/SRR18110025.deterministic-qnames-1000.fastq.gz"
    "MITO_OVERVIEW_LONGREAD_ALIGN_BAM=${CACHE_ROOT}/GM12878/alignment/GM12878_ONT_longread.deterministic-qnames-1000.mt.bam"
