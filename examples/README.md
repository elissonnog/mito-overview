...
- [`public_validation/GM11906_MERRF_shortread`](public_validation/GM11906_MERRF_shortread): figures, summaries, and provenance from the fixed GM11906 short-read input
...
The GM11906 default profile reports `33` candidates, `44,052,664` accepted observations, and `7,293,106` excluded observations. At `m.8344A>G`, depth is `1,027`, alternate count is `740`, and `AF=0.720545`.
